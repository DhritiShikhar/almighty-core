...
func (m *GormIterationRepository) Create(ctx context.Context, u *Iteration) error {
	...
	activeStatus := CalculateActiveIterationOnCreate(u.UserActive, u.StartAt, u.EndAt)
...
func CalculateActiveIterationOnCreate(userActive *bool, startAt *time.Time, endAt *time.Time) bool {
	if userActive != nil {
