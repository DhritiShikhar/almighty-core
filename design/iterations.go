...
var iterationAttributes = a.Type("IterationAttributes", func() {
	...
	a.Attribute("user-active", d.Boolean, "Manually enforced active status by user", func() {
	})
	a.Attribute("active_status", d.Boolean, "Active status of iteration calculated using user-active, startAt and endAt", func() {
	})
